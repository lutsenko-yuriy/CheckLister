...
CheckLister — A cross-platform checklist app for iOS and Android
...
Feature-based modules with React Navigation and local persistence
...
- **Release build (iOS, signed):** `bundle exec fastlane beta version:<x.y.z> build:<n>` — see `docs/VERSIONING.md`
